...
public class SqlServerClusteringSiloOptionsValidator : IConfigurationValidator
{
    ...
    public void ValidateConfiguration()
    {
        ...
        {
            throw new OrleansConfigurationException($"Invalid {nameof(SqlServerClusteringSiloOptions)} values for {nameof(SqlServerClusteringTable)}. {nameof(options.Invariant)} is required.");
        }
